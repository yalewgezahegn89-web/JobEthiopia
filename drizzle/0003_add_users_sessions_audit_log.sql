CREATE TYPE "public"."user_role" AS ENUM('SUPER_ADMIN', 'ADMIN', 'MODERATOR', 'ORGANIZATION_ADMIN', 'CANDIDATE');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "sources" ALTER COLUMN "consecutive_failures" SET DEFAULT 0;--> statement-breakpoint
